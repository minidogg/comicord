...
import {getDiscordAppPath} from '../utils/pathUtil.js';
...
export function copyFileInfo(filePath, resultPath){
    let destPath = path.join(resultPath, filePath.replace(discordAppPath, ""))
...
export function packageAsar(folderPath, asarPath){
